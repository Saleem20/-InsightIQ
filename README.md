...
src/
  ...
  data_layer.py           <- Social listening data (mock, 25-30 posts x 5 topics)
...
| Topics | NMF topic treemap, Topic summary table |
...
5. Add OPENAI_API_KEY in Advanced Settings > Secrets
6. Click Deploy
