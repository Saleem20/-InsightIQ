...
RSS_PRESETS = {
    ...
    "Reddit search": "https://www.reddit.com/search.rss?q={query}",
}
CATEGORY_KEYWORDS = {
...
with st.sidebar:
    ...
    data_mode = st.radio(
        "Data source",
        ["Live RSS / web search", "Upload platform export", "Blend live/upload with demo fallback", "Demo data"],
        index=2,
    )
...
raw_df, source_warnings, source_label = build_data_source(data_mode, uploaded_file, query, custom_feeds)
